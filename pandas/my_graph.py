...
print(football_anal(1))     # ВЫВОДИМ РЕЗУЛЬТАТЫ В КОНСОЛЬ (1) ИЛИ (0) ЕСЛИ НЕ ВЫВОДИМ

# ВЫБОР ГРАФА И ВЫВОД ЕГО НА ЭКРАН C СОХРАНЕНИЕМ В ФАЙЛ

graph_links(0)              # ВЫБОР ГРАФА СВЯЗЕЙ (1) - ДА, (0) - НЕТ
graph_daily_statistic(0)    # ВЫБОР ГРАФА ЕЖЕДНЕВНЫХ ЗНАЧЕНИЙ (1) - ДА, (0) - НЕТ
graph_football(0)           # ВЫБОР ГРАФА ФУТБОЛЬНОЙ СТАТИСТИКИ (1) - ДА, (0) - НЕТ
run_plt(0, 0)               # СОХРАНЕНИЕ И ОТРИСОВКА ГРАФА (1) - ДА, (0) - НЕТ
